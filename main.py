...
if __name__ == "__main__":
    ...
    out = "find_shared_gaps/test_gaps_padded_15.json"
    openiti_base_dir = "E:/OpenITI Corpus/corpus_2023_1_8"
    book_list = ["0630IbnAthirCizzDin.Kamil"]

    run_pipeline(cluster_path, meta_path, openiti_base_dir, book_list= book_list, raw_gaps_out=out, offset_padding=15)